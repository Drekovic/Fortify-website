...
*/
        ...
        <div class='tt-form-element'><div class='tt-form-label'>Theme Features List</div>
            <div class='tt-element-content'><p>
                ...
                <ul style='list-style: disc; padding-left: 25px;'>
                    ...
                    <li>Responsive Design (Phone &amp; Tablet Friendly)</li>
                    <li>Shortcodes</li>
    ...
    */
    ...
    $this->admin_option('General',
        ...
        'raw', '<div class="tt-notice">You are eligible for discounted wordpress hosting at <a href="http://ejeet.net/hosted" target="_blank">Ejeet Networks</a><br />Migrating is easy. You will NOT lose your current settings or already made customizations.</div>', 
        array('priority' => '1')
    ); //the_theme_slug_url
